...
export default class RightCell extends Component<any, any> {
    render() {
        return (
    ...
    renderImg() {
        if (this.props.isPlay) {
            ...
            return (<Image source={{ uri: 'https://os.alipayobjects.com/rmsportal/IptWdCkrtkAUfjE.png' }} style={styles.cellImg} resizeMode={'contain'} />)
        }
    }
}
